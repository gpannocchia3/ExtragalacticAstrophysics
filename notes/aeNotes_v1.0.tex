...
\include{aeNotes-config}

\author{Giacomo Pannocchia} 
\title{\textcolor{black}{NOTES OF}\\ \textcolor{RawSienna}{Extragalactic Astrophysics \\ and Cosmology} \\ \vspace{7pt}\large \quad \quad \quad \quad \quad \textcolor{black}{version 1.0}}
\date{a.y. 2025-2026}
