...
\par These notes will be mainly based on \emph{my} own notes of the lectures by Professor Michele Cignoni during the academic year 2025-2026 and the slides available in the Teams channel for the course. At the end of each chapter you'll also find some questions to "guide" your studies and revisions. However, since I take little to no pride in my messy notes, I'll be often using some of the references you can find on the course catalogue page or that have been cited during class. Either way, I'll do my best keeping track of them all in the bibliography of this humble collection.
