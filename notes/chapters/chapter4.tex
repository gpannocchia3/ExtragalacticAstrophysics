...
\par The most reliable and widely used technique involves the "pairing" of stars of identical spectral type (so about the same temperature) and luminosity class (so about the same surface gravity) but unequal reddening
\begin{align*}
...
\end{equation*}
Let’s calculate again a spectrum-averaged absorption cross section like we've defined somewhere in the above. The radiative heating rate is simply 
\begin{equation*}
